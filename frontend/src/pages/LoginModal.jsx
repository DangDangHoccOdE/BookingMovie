        ...
        <div className="modal-fade" id="loginModal" tabIndex="-1" aria-labelledby="loginModalLabel" aria-hidden={"true"}>
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header login-mnodal-header">
                        <h5 className="modal-title" id="loginModalHeader">Đăng nhập</h5>
                        ...
                        <Form>
                            <div className="modal-body">
                                ...
                                <p className="ps-2 text-start">
                                    ...
                                    <a href="!#" style={{color:"black"}} data-bs-toggle="modal" data-bs-target="#registerModal">Đăng ký ngay</a>
                                </p>
                            </div>
