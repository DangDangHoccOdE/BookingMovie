    ...
    return(
        <div>
                        ...
                        <div className='col-sm-12 col-md-6 text-start text-light'>
                            ...
                            <div className='row gy-1 justify-content-start align-items-end mt-5'>
                                <div className='col-sm-4'>
                                    <button className='detail-page-btn btn btn-light btn-lg col-12' type="button" onClick={() => document.querySelector("#ticketBuy").scrollIntoView(
                                        {behavior: "smooth",}
                                    )}>
                                ...
                                [0,1,2,3,4,5,6].map((i) => (
                                    <li className='nav-item'>
                                        <a className='nav-link active date-converter-ticket' aria-current="page"
                                           href="#!" onClick={() => setSelectedDay(dateConverter(new Date().setDate(date.getDate() + i)))}>
                                            {dateConvertForTicket(new Date().setDate(date.getDate()+1))}
                                        </a>
                                    </li>
                                ))
                            }
            ...
            <section className='py-5'>
                ...
                <Swiper slidesPerView={5} spaceBetween={0} pagination={{clickable: true}} modules={[Pagination]} className='mySwiper movie-slider'>
                                ...
                                <div className='slider-item-caption d-flex align-items-end justify-content-center h-100 w-100'>
                                    <div className='d-flex align-items-center flex-column mb-3' style={{height: "20rem"}}>
                                        ...
                                        <div className='p-2 d-grid gap-2'>
                                            <a className='slider-button btn btn-light btn-md rounded d-none d-sm-block' onClick={() => {
                                                navigate("/movie/" + movie.movieId)
                                                getNewVisionMovie(movie.movieId)};
                                            }>
                                                <strong>Để lại một bình luận</strong>
